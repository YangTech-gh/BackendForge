...
export const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-zinc-950/85 backdrop-blur-md flex items-center justify-center p-4" role="dialog" aria-modal="true">
      <div className="bg-zinc-900 border border-zinc-800 rounded-3xl w-full max-w-sm shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        <div className="p-6 bg-gradient-to-br from-red-950 via-zinc-900 to-indigo-950 border-b border-red-500/30 text-center space-y-2 relative">
          ...
          <h2 className="text-xl font-extrabold text-white">Welcome to Backend Forge</h2>
          <p className="text-xs text-zinc-300">Sign in to start your engineering journey</p>
        </div>
        ...
        <div className="p-6 space-y-3">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center space-x-2 bg-zinc-800 hover:bg-zinc-700 text-white font-bold py-3 rounded-xl text-sm transition border border-zinc-700"
          >
          ...
          {loading && (
            <div className="flex items-center justify-center gap-2 text-xs text-zinc-400 bg-zinc-800/40 p-3 rounded-lg border border-zinc-700/50">
